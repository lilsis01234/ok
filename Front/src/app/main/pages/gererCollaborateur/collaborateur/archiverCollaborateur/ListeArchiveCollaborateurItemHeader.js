                ...
                <div className="flex flex-col items-center sm:items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="flex mx-4 font-medium">Archive des collaborateurs</span>
                        </Typography>
                    </motion.div>
...
export default ListeArchiveCollaborateurItemHeader
