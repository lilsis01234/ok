        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col flex-0 lg:flex-row items-center max-w-5xl w-full mx-auto px-32 lg:h-72">
            ...
            <div className="flex flex-col items-center lg:items-start mt-16 lg:mt-0 lg:ml-32">
              <Typography className="text-lg font-bold leading-none">Andriajatovo Toavina</Typography>
              <Typography color="text.secondary">Développeur, Fivoarana</Typography>
            </div>
            ...
            <div className="flex flex-1 justify-end my-16 lg:my-0">
              ...
              >
                <Tab
                  ...
                  ableRipple
                  label="page de Gestion d'actualités"
                />
              </Tabs>
            </div>
          </div>
...
export default AddActualityApp;  