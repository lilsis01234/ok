...
//Récuperer les membres des équipes
router.get('/:id/allCollab', async(req, res) => {
    try {
        ...
        console.error('Erreur lors de la récupération des collaborateurs de l\'équipe', error);
        res.status(500).json({ message: 'Erreur lors de la récupération des collaborateurs de l\'équipe' });
    }
})
