...
router.get('/liste_collaborateur', (req, res) => {
    CompteCollab.findAll({
        include: {
            model: Collaborateur, attributes: ['matricule', 'nom', 'prenom', 'dateNaissance', 'lot', 'quartier', 'ville', 'tel', 'dateEmbauche', 'site', 'image', 'poste'],
            include: {
                model: Poste, attributes: ['titrePoste', 'departement'],
