...
//recherche globale 
  ...
  const [rechercheEquipe, setRechercheEquipe] = useState('null');
              ...
              <table className="w-full min-w-max table-auto text-left text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type='text' id='filtre' className="add-input" placeholder="Equipe" onChange={(e) => setRechercheEquipe(e.target.value)} /></td>
