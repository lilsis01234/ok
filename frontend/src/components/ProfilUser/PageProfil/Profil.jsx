...
const Profil = () => {
    ...
    useEffect(() => {
        axios.get(`http://192.168.16.244:4003/api/user/account/${idProfile}`)
            .then(response => {
                ...
                <div className="main-content">
                    <div className="bg-black rounded-md userProfile flex flex-row">
                        <div className="m-8 p-5 grid grid-row-3">
                            <Avatar src={`http://192.168.16.244:4003/${collaborateurData.image}`} variant="rounded" className="row-span-2 imagePhoto"/>
