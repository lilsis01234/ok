  ...
  return (
   <>
     ...
     <div className="listePoste">
        <h1 className="listePoste_title">Listes de postes </h1>
        ...
        <table className="listePoste_table">
            <thead>
               <tr>
                   <th className="listePoste_tableId">N°</th>
                   <th>Poste</th>
                    <th>Département</th>
                   <th></th>
               </tr> 
          ...
          <tbody>
            {searchTerm === '' ? (listePoste.map(poste => (
                <tr key={poste.id}>
                 <td className="listePoste_tableId">{poste.id}</td>
                 <td>{poste.titrePoste}</td>
                 <td>{poste.nomDepartement}</td>
                 <td>
                     <button className="listePoste_EditButton" onClick={() => {EditPoste(poste.id); openEditModal()}}><MdEdit/> Modifier </button>
                 </td>
                </tr>
     ...
     <div className="modal_AddForm">
         <Modal 
            ...
            <h2 className="modal_AddForm_Title">Ajouter un poste</h2>
